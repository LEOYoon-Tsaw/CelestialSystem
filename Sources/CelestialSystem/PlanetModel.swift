...
public struct SolarSystem: Sendable, Equatable {
    ...
    public struct SphericalLoc: Sendable, Equatable {
        public let ra: Double
        public let decl: Double
        public let r: Double
    }

    public struct Planet: Sendable, Equatable {
        public let loc: SphericalLoc
        public let diameter: Double
    }

    public struct Planets: Sendable, Equatable {
        public let sun: Planet
        public let moon: Planet
        public let mercury: Planet
        public let venus: Planet
        public let mars: Planet
        public let jupiter: Planet
        public let saturn: Planet
    }

    public enum Targets: Sendable, Equatable {
    ...
    public static func normalize(radian: Double) -> Double {
